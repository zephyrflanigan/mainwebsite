...
export const base = {rootscrollgutter,svg,scrollbar,properties,rootcolor,rootscrolllock};
export const components = {skeleton,mask,status,checkbox,radio,collapse,fieldset,diff,hover3d,textrotate,kbd,avatar,rating,stat,dropdown,filter,megamenu,toggle,swap,link,hovergallery,select,badge,mockup,calendar,divider,modal,steps,list,breadcrumbs,chat,radialprogress,aura,range,stack,fileinput,carousel,alert,drawer,fab,input,toast,menu,tab,navbar,countdown,textarea,card,label,indicator,progress,otp,table,hero,button,validator,timeline,footer,loading,dock,tooltip};
